...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
                        ...
                        <div class="page-title-breadcrumb">
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li>
                                   ...
                                   <li><a class="parent-item" href="">Compras</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>                             
                            </ol>
                        </div>
                    </div>
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            ...
            include("modal/editar_compras.php");
            ?>
               ...
               <form class="form-horizontal" role="form" id="datos_cotizacion">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" class="form-control" id="q" placeholder="Código o Compra" onkeyup='load(1);'>
                            </div>
                            <div class="col-md-3">
              ...
              <button type="button" class="btn blue-bgcolor btn-outline btn-circle sm-5"  onclick='load(1);'>
                ...
                <button type="button" class="btn purple btn-outline btn-circle margin-0" data-toggle="modal" data-target="#nuevacompra">
     ...
     $.ajax({
            ...
            data: parametros,
             beforeSend: function(objeto){
                $("#resultados_ajax_compras").html("Mensaje: Cargando...");
              },
            success: function(datos){
            $("#resultados_ajax_compras").html(datos);
...
$( "#editar_compra" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
  ...
  event.preventDefault();
    ...
    function obtener_datos(id){
            var codigo_compra = $("#codigo_compra"+id).val();
            var nombre_compra = $("#nombre_compra"+id).val();
            var estado = $("#estado"+id).val();
            var precio_compra = $("#precio_compra"+id).val();
            $("#mod_id").val(id);
            $("#mod_codigo").val(codigo_compra);
            $("#mod_nombre").val(nombre_compra);
            $("#mod_precio").val(precio_compra);
