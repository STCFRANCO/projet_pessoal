...
-- --------------------------------------------------------
CREATE TABLE IF NOT EXISTS `detalle_pre` (
  `id_detalle` int(11) NOT NULL,
  `numero_pre` int(11) NOT NULL,
  `id_producto` int(11) NOT NULL,
  `cantidad` int(11) NOT NULL,
  `precio_venta` double NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(1, 'Eliecer', 'Franco', 'admin', '$2y$10$MPVHzZ2ZPOWmtUUGCq3RXu31OTB.jo7M9LZ7PmPQYmgETSNn19ejO', 'admin@admin.com', '2016-05-21 15:06:00');
...
ALTER TABLE `detalle_pre`
  ADD PRIMARY KEY (`id_detalle`),
  ADD KEY `numero_pre` (`numero_pre`,`id_producto`);
...
ALTER TABLE `presupuesto`
  ...
  ADD UNIQUE KEY `numero_pre` (`numero_pre`);
